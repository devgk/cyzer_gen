...
include_once(CYZ_LIB.'/file-management/file-operator.php');
...
function cyz_setup_db_config(){
  /** Run Controller => Setup Apache Htaccess */
  $setup_config = cyz_create_db_config_file();

  /** Apache Setup Completed */
  if($setup_config['status']) return [
    'status' => true,
    'description' => 'success'
  ];
